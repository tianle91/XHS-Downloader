...
A batch-download web interface built on top of ``source.XHS`` that writes each
link into its own folder on disk. All feature code is contained in this folder.
